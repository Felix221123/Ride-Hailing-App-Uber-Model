...
export class NewMigration1740947385465 implements MigrationInterface {
    name = 'NewMigration1740947385465'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "admin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "emailAddress" character varying, "password" character varying NOT NULL, "role" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP, "status" character varying NOT NULL, "sessionToken" uuid DEFAULT uuid_generate_v4(), "permissions" character varying NOT NULL DEFAULT '[]', CONSTRAINT "PK_e032310bcef831fb83101899b10" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "driver" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "emailAddress" character varying, "password" character varying NOT NULL, "role" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP, "status" character varying NOT NULL, "sessionToken" uuid DEFAULT uuid_generate_v4(), "vehicleNumber" json, "isAvailable" boolean NOT NULL, "location" character varying NOT NULL, "totalEarnings" double precision NOT NULL DEFAULT '0', "rideHistory" json, CONSTRAINT "PK_61de71a8d217d585ecd5ee3d065" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "customer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "emailAddress" character varying, "password" character varying NOT NULL, "role" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP, "status" character varying NOT NULL, "sessionToken" uuid DEFAULT uuid_generate_v4(), "paymentMethod" character varying NOT NULL, "rideHistory" json, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
